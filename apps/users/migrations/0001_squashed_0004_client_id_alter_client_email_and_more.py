...
class Migration(migrations.Migration):
    ...
    replaces = [('users', '0001_initial'), ('users', '0002_alter_magiclink_expires_at'), ('users', '0003_remove_client_is_superuser_client_is_staff_and_more'), ('users', '0004_client_id_alter_client_email_and_more')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True, help_text=' The timestamp for an address needs to be kept to comply with\n                      local privacy laws like GDPR. We might issue notices and proceed\n                      to automatically delete the address once the legal period requires\n                      us to do so. ', verbose_name='Address creation timestamp')),
                ('name', models.CharField(max_length=128, verbose_name='Name')),
                ('address1', models.CharField(max_length=128, verbose_name='Address line 1')),
                ('address2', models.CharField(max_length=128, verbose_name='Address line 2')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('secret', models.CharField(auto_created=True, default=django.core.management.utils.get_random_secret_key, max_length=50, verbose_name='Secret')),
                ('expires_at', models.DateTimeField(default='2023-10-17 18:55:53.007393')),
